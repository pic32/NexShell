 ...
 *
 * @details
 * This function is what is eventually called when the user issues the help command through
 * the shell.  Any output that is generated by the help command is written to the OutputStream.
 */
